...
$Env:syn1737_WorkspaceDefaultSqlServer_connectionString = $UpdatedConfigContent.parameters.syn1737-WorkspaceDefaultSqlServer_connectionString.value
...
$Env:syn1737_WorkspaceDefaultStorage_properties_typeProperties_url = $UpdatedConfigContent.parameters.syn1737-WorkspaceDefaultStorage_properties_typeProperties_url.value
