...
$Env:syn1737-WorkspaceDefaultSqlServer_connectionString = $UpdatedConfigContent.parameters.syn1737-WorkspaceDefaultSqlServer_connectionString.value
...
$Env:syn1737-WorkspaceDefaultStorage_properties_typeProperties_url = $UpdatedConfigContent.parameters.syn1737-WorkspaceDefaultStorage_properties_typeProperties_url.value

# Rerun the workflow with the updated configuration values
Invoke-Expression -Command "Your command to rerun the workflow with the new environment variables"
